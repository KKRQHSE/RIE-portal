...
export const INSP_TEKST: Woordenboek = {
  ...
  aiDoetVoorstel:   { nl: 'De AI doet alleen een voorstel. Jij vinkt aan wat je overneemt.', tr: 'AI yalnızca bir öneri sunar. Neyi aktaracağınızı siz işaretlersiniz.' },
  aiWatAiZiet:      { nl: 'Wat de AI op de foto ziet', tr: 'AI’nın fotoğrafta gördüğü' },
  aiBevindingenLabel: { nl: 'Mogelijke bevindingen — vink aan wat je overneemt', tr: 'Olası bulgular — aktaracaklarınızı işaretleyin' },
  aiActiesLabel:    { nl: 'Voorgestelde acties — vink aan wat je overneemt', tr: 'Önerilen önlemler — aktaracaklarınızı işaretleyin' },
  aiGeenVoorstellen: { nl: 'De AI ziet hier geen aandachtspunt.', tr: 'AI burada dikkat edilecek bir nokta görmüyor.' },
  aiOvernemen:      { nl: 'Overnemen', tr: 'Aktar' },
  ...
  aiEerstResultaat: { nl: 'Kies eerst hierboven een resultaat; daarna kun je een aangevinkte bevinding overnemen als toelichting.', tr: 'Önce yukarıdan bir sonuç seçin; daha sonra işaretli bir bulguyu açıklama olarak aktarabilirsiniz.' },
  ...
  aiNietsAangevinkt: { nl: 'Vink eerst iets aan om over te nemen.', tr: 'Aktarmak için önce bir şey işaretleyin.' },
