...
-- Gegenereerd door scripts/dump_schema.mjs op 2026-06-27T18:58:47.507Z
...
GRANT EXECUTE ON FUNCTION public.bedrijf_toolbox_overzicht(p_company_id uuid) TO anon;
...
GRANT EXECUTE ON FUNCTION public.centrale_toolbox_archiveren(p_id uuid) TO anon;
...
GRANT EXECUTE ON FUNCTION public.centrale_toolbox_opslaan(p_id uuid, p_titel text, p_tekst text, p_video_url text, p_vereist_video boolean, p_vereist_quiz boolean, p_quiz_slaaggrens integer, p_quiz_uitleg_modus text, p_toegang text, p_volgorde integer) TO anon;
...
GRANT EXECUTE ON FUNCTION public.centrale_toolbox_vraag_archiveren(p_id uuid) TO anon;
...
GRANT EXECUTE ON FUNCTION public.centrale_toolbox_vraag_opslaan(p_id uuid, p_toolbox_id uuid, p_vraagtekst text, p_opties jsonb, p_juist_antwoord integer, p_uitleg text, p_volgorde integer) TO anon;
...
GRANT EXECUTE ON FUNCTION public.doelstelling_zetten(p_company_id uuid, p_functiegroep_id uuid, p_doel_per_jaar integer) TO anon;
...
GRANT EXECUTE ON FUNCTION public.toolbox_koppelen(p_company_id uuid, p_toolbox_id uuid) TO anon;
...
GRANT EXECUTE ON FUNCTION public.toolbox_lokaal_aanpassen(p_company_id uuid, p_toolbox_id uuid, p_lokale_titel text, p_lokale_tekst text, p_lokale_video_url text) TO anon;
...
GRANT EXECUTE ON FUNCTION public.toolbox_ontkoppelen(p_company_id uuid, p_toolbox_id uuid) TO anon;
...
GRANT EXECUTE ON FUNCTION public.toolbox_terug_naar_centraal(p_company_id uuid, p_toolbox_id uuid) TO anon;
...
GRANT EXECUTE ON FUNCTION public.toolbox_uitzetten(p_company_id uuid, p_toolbox_id uuid) TO anon;
