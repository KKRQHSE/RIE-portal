...
-- Gegenereerd door scripts/dump_schema.mjs op 2026-09-11T12:42:02.198Z
...
CREATE POLICY audit_sel ON public.audit AS PERMISSIVE FOR SELECT TO public
...
REVOKE EXECUTE ON FUNCTION public.audit_bewaak(p_audit_id uuid) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.audit_bewaak(p_audit_id uuid) TO service_role;
REVOKE EXECUTE ON FUNCTION public.audit_iso_observatie_opslaan(p_id uuid, p_patch jsonb) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.audit_iso_observatie_opslaan(p_id uuid, p_patch jsonb) TO authenticated;
GRANT EXECUTE ON FUNCTION public.audit_iso_observatie_opslaan(p_id uuid, p_patch jsonb) TO service_role;
REVOKE EXECUTE ON FUNCTION public.audit_iso_observatie_toevoegen(p_audit_id uuid) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.audit_iso_observatie_toevoegen(p_audit_id uuid) TO authenticated;
GRANT EXECUTE ON FUNCTION public.audit_iso_observatie_toevoegen(p_audit_id uuid) TO service_role;
...
REVOKE EXECUTE ON FUNCTION public.audit_patch_controle(p_patch jsonb, p_toegestaan text[]) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.audit_patch_controle(p_patch jsonb, p_toegestaan text[]) TO service_role;
REVOKE EXECUTE ON FUNCTION public.audit_vca_bevinding_opslaan(p_id uuid, p_patch jsonb) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.audit_vca_bevinding_opslaan(p_id uuid, p_patch jsonb) TO authenticated;
GRANT EXECUTE ON FUNCTION public.audit_vca_bevinding_opslaan(p_id uuid, p_patch jsonb) TO service_role;
REVOKE EXECUTE ON FUNCTION public.audit_verbeterpunt_opslaan(p_id uuid, p_patch jsonb) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.audit_verbeterpunt_opslaan(p_id uuid, p_patch jsonb) TO authenticated;
GRANT EXECUTE ON FUNCTION public.audit_verbeterpunt_opslaan(p_id uuid, p_patch jsonb) TO service_role;
REVOKE EXECUTE ON FUNCTION public.audit_verbeterpunt_toevoegen(p_audit_id uuid) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.audit_verbeterpunt_toevoegen(p_audit_id uuid) TO authenticated;
GRANT EXECUTE ON FUNCTION public.audit_verbeterpunt_toevoegen(p_audit_id uuid) TO service_role;
REVOKE EXECUTE ON FUNCTION public.audit_verbeterpunt_verwijderen(p_id uuid) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.audit_verbeterpunt_verwijderen(p_id uuid) TO authenticated;
GRANT EXECUTE ON FUNCTION public.audit_verbeterpunt_verwijderen(p_id uuid) TO service_role;
